...
def managed_download(target: List[str] = ["Instagram", "Pinterest"], next_id: int = 1, ins_max: int = 5, pin_max: int = 50):
    ...
    if "Instagram" in target:
        ...
        try: 
            after_id = run_instagram_scrape(start_id=id_counter, base_path=BASEPATH, max_scroll=ins_max)
